#' Multivariable MR longitudinal data simulation
#'
...
#'
multivariable_MR_simulation <- function(n = 30000, alpha_U = 0.3, 
                                    B0_A0 = 1, B1_A1 = 1,
                                    A0_A1 = 1, B0_B1 = 1,
                                    A1_Y = 1, B1_Y = 1,
                                    A0_B1 = 0, B0_A1 = 0,
  ...
  Y <- A0_Y*A0 + B0_Y*B0 + A1_Y*A1 + B1_Y*B1  + alpha_U*U
  ...
  Y  <- A0_Y*A0 + B0_Y*B0 + A1_Y*A1 + alpha_U*U
